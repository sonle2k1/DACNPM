...
$msg="Chỉnh sửa hãng xe thành công";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Chỉnh sửa hãng xe</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Nhập</div>
										...
										<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Nhập</button>
												</div>
											</div>
