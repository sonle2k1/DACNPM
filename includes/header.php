...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
           ...
           <?php if($_SESSION['login']){?>
            <li><a href="profile.php">Chỉnh sửa hồ sơ</a></li>
              <li><a href="update-password.php">Thay đổi mật khẩu</a></li>
          
            <li><a href="logout.php">Đăng xuất</a></li>
            <?php } else { ?>
            <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">Chỉnh sửa hồ sơ</a></li>
              <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">Thay đổi mật khẩu</a></li>
        
            <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">Đăng nhập</a></li>
            <?php } ?>
          </ul>
            </li>
          </ul>
